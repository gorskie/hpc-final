/**
 * To compile:  gcc -Wall -g -O3 -march=native 2d-fdtd-additive-s.c matrix.c util.c -o 2d-fdtd-additive-s -lm
 * To run: ./2d-fdtd-additive-s output-2d-s.npy
**/
#include <math.h>
#include <stdlib.h>
#include <stdio.h>
...
int main(int argc, const char *argv[]) {
    ...
    if (argc > 1) {
        ...
        output_loc = "./output-fdtd-2d-additive.npy";
    }
